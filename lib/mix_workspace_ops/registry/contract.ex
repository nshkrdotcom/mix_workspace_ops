defmodule MixWorkspaceOps.Registry.Contract do
  ...
  def validate(repositories, applications, _schema) do
    with :ok <- validate_current_providers(applications),
         :ok <- validate_groups(repositories),
  ...
  defp validate_groups(repositories) do
